...
<details>
  ...
  Build an express application that enables users to count down the number of bottles of juice. <br />
  
  Specs: <br />
    1. On the home page (`get "/"`), users should see:
      a. "99 Bottles of juice on the wall"
      b. a link that says "take one down, pass it around"
      c. this should link to `/98`, where the number represents the number of bottles left.
    2. When a number is given in the url (`get "/:number_of_bottles"`), users should see:
      a. number of bottles "Bottles of juice on the wall"
      b. a link to "take one down, pass it around", where the href is number of bottles minus 1.
    3. If there are 0 bottles left, do not show a link to "take one down"
      a. Add a link to start over, which directs the user back to the home page.
